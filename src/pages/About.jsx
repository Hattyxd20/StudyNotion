...
import FoundingStoary from "../assets/Images/FoundingStory.png"
  ...
  return (
     <div className=''>
        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          ...
          <div className='sm:h-[150px] lg:h-[230px]'></div>
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          ...
          <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
            <div className="my-8 flex lg:w-[40%] flex-col gap-10">
        ...
        <section className='mx-auto max-w-maxContent flex justify-between mt-20 flex-col gap-10 text-white items-center'>
            <LearningGrid/> 
            <ContactFormSection/>
