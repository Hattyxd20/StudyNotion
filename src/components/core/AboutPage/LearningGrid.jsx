     ...
     <div className='grid mx-auto w-[350px] xl:w-fit grid-cols-1 xl:grid-cols-4 mb-12' >
          {
              LearningGridArray.map( (item,index) => {
                   return (
                     <div key={index} className={`${index === 0 && "hidden md:block xl:col-span-2 xl:h-[294px] bg-transparent"}
                     ${item.order % 2 === 1 ? "bg-richblack-700 h-[294px]" : "bg-richblack-800 h-[294px]"}
                     ${item.order === 3 && "col-start-2"}`}>
                      
                      {
                         item.order < 0 ? (<div className='xl:w-[90%] flex flex-col gap-3 pb-10 xl:pb-0'>
